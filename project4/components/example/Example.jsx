...
class Example extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      motto: window.cs142models.exampleModel2().motto,
      mottoInput: '',
      counter: 0,
      inputValue: '',
      buttonWasClicked: '',
    ...
    this.handleMottoInputBound = event => this.handleMottoInput(event);
    this.handleMottoButtonBound = event => this.handleMottoButton(event);
  ...
  handleMottoInput(event) {
    this.setState({ mottoInput: event.target.value });
    console.log(this.state.mottoInput);
  }

  handleMottoButton(event) {
    this.setState({ motto: this.state.mottoInput});
    console.log(this.state.mottoInput, event);
  }
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          ...
          <p>
            Enter your own motto!
            <input type="text" value={this.state.mottoInput} onChange={this.handleMottoInputBound} />
            <button type="button" onClick={this.handleMottoButtonBound}>
              Submit!
            </button>
          </p>
