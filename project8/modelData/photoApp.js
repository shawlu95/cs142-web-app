...
(function() {
   ...
   var ty = {_id: "57231f1a30e4351f4e9f4bdd", first_name: "Tingyu", last_name: "Zheng",
             location: "Stanford, CA", description: "Cutiest girl on earth.", occupation: "Being the cutiest girl on earth."};
   var my = {_id: "57231f1a30e4351f4e9f4bde", first_name: "Ming", last_name: "Yao",
             location: "Centauri", description: "", occupation: "无业游民"};

   var users = [ty, im, er, pt, rk, al, jo, my];
   ...
   var photo13 = {_id: "57231f1a30e4351f4e9f4be9", date_time: "2019-05-16 17:12:28", file_name: "zheng2.jpg", user_id: ty._id};
   var photo14 = {_id: "57231f1a30e4351f4e9f4bea", date_time: "2019-05-17 18:12:28", file_name: "zheng3.jpg", user_id: ty._id};
   var photo15 = {_id: "57231f1a30e4351f4e9f4beb", date_time: "2019-05-18 08:12:28", file_name: "zheng4.jpg", user_id: ty._id};
   var photos = [photo1, photo2, photo3, photo4, photo5, photo6, photo7,
      photo8, photo9, photo10, photo11, photo12, photo13, photo14, photo15];
   ...
   var comment14 = {
      _id: "57231f1a30e4351f4e9f4bf6",
      comment: "Napa is fun.", user: ty, photo_id: photo13._id
   };

   var comment15 = {
      _id: "57231f1a30e4351f4e9f4bf7",
      comment: "小可爱！", user: jo, photo_id: photo13._id
   };

   var comment16 = {
      _id: "57231f1a30e4351f4e9f4bf8",
      comment: "哈哈哈哈哈哈哈哈哈哈哈", user: ty, photo_id: photo13._id
   };

   var comment17 = {
      _id: "57231f1a30e4351f4e9f4bf9",
      comment: "锄禾日当午，汗滴禾下土", user: ty, photo_id: photo14._id
   };

   var comments = [comment1, comment2, comment3, comment4, comment5, comment6, comment7,
   comment8, comment9, comment10, comment11, comment12, comment14, comment15, comment16, comment17];

   const a1 = {
     user_id: my._id,
     activity: "LOGOUT",
     photo_id: null,
     date_time: "2019-05-01 18:12:28",
     file_name: null
   }
   const a2 = {
     user_id: my._id,
   ...
   const a4 = {
     ...
     date_time: "2019-05-19 23:42:44",
     file_name: "zheng2.jpg"
   }
   const a5 = {
     user_id: pt._id,
     activity: "COMMENT",
     photo_id: photo10._id,
     comment_id: comment10._id,
     date_time: "2019-05-20 11:43:13",
     file_name: "took2.jpg"
   }
   const a6 = {
     ...
     activity: "LOGOUT",
     photo_id: null,
     date_time: "2019-05-21 22:43:55",
     file_name: null
   }
   var activities = [a1, a2, a3, a4, a5, a6];
